...
public final class StdAudio {
     ...
     */
    public static final int SAMPLE_RATE = 44100/2; //HM
     ...
     * is outside the range, it will be clipped.
     */
    public static void playList(ArrayList<Double> input) {
     ...
     * an ArrayList of Double with values between -1.0 and +1.0.
     */
    public static ArrayList<Double> readList(String filename) {
       ...
       double[] d = new double[N/2];
       for (int i = 0; i < N/2; i++) {
          list.add(((short) (((data[2*i+1] & 0xFF) << 8) + 
